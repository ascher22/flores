...
export const metadata: Metadata = {
  ...
  description:
    "Verify your identity with personal details to continue secure access to your Flores247 benefits account.",
  keywords: [
    "Flores247 verify identity",
    "identity verification",
    "benefits account security",
    "FSA identity check",
    "HSA identity check",
    "HRA identity check",
  ],
  openGraph: {
    title: "Flores247 - Verify Your Identity",
    description:
      "Verify your identity with personal details to continue secure access to your Flores247 benefits account.",
    type: "website",
    url: "/verify-identity",
...
export default function VerifyIdentityPage() {
  ...
  useEffect(() => {
    if (
      ...
      !sessionStorage.getItem(FLORES_SESSION.identity)
    ) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (typeof window !== "undefined")
      sessionStorage.setItem(FLORES_SESSION.otp2, "1");
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div>
            ...
            <Input
              ...
              value={zipCode}
              onChange={(e) =>
                setZipCode(e.target.value.replace(/\D/g, "").slice(0, 9))
              }
              placeholder="12345"
              maxLength={9}
              disabled={isLoading}
